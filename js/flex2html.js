...
function box_object(json) {
   ...
   if (offsetTop && /px|%/.test(offsetTop)) {
      style += `top:${offsetTop};`
      ext = ''
   } else {
   ...
   if (paddingAll && /px|%/.test(paddingAll)) {
   ...
   if (paddingTop && /px|%/.test(paddingTop)) {
   ...
   if (paddingBottom && /px|%/.test(paddingBottom)) {
   ...
   if (paddingStart && /px|%/.test(paddingStart)) {
   ...
   if (paddingEnd && /px|%/.test(paddingEnd)) {
